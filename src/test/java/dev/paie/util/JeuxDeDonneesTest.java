...
public class JeuxDeDonneesTest {
	...
	public void test_cotisationsNonImposables() {
		assertThat(bulletin1.getRemunerationEmploye().getProfilRemuneration().getCotisationsNonImposables())
				.extracting(cotNonImp -> cotNonImp.getCode()).contains("EP01", "EP02", "EP03", "EP04", "EP05", "EP06",
						"EP07", "EP12", "EP19", "EP20", "EPR1", "E900", "EP28", "EP37");
	}

	@Test
	public void test_cotisationImposables() {
		assertThat(bulletin1.getRemunerationEmploye().getProfilRemuneration().getCotisationsImposables())
				.extracting(cotImp -> cotImp.getCode()).contains("SP01", "SP02");
	}
